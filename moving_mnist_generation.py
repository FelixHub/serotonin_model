...
###########################################################################################
# script to generate moving mnist video dataset
# source: https://gist.github.com/tencia/afb129122a64bde3bd0c
#
# usage:
# `python moving_mnist.py`
# (assumes that you have a folder called `data` in the same directory)
#
# variables of interest:
# direcs: (lines 126-127) - directions to move the numbers
# speeds: (lines 128-129) - speeds to move the numbers
# positions: (lines 146-147) - positions to start the numbers
#
###########################################################################################
...
def generate_moving_mnist(
    ...
    for img_idx in range(num_images):
        ...
        direcs = np.array([0.25, 0.75]) * np.pi
        ...
        positions = np.asarray([(0.1 * x_lim, 0.1 * y_lim), (0.1 * x_lim, 0.9 * y_lim)])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_frames", type=int, dest="num_frames", default=20
    )  # length of each sequence
    parser.add_argument(
        "--num_images", type=int, dest="num_images", default=200
